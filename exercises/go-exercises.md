# 🐹 Go (Golang) Practice Roadmap

## 🟢 LEVEL 1 — Go Fundamentals (Absolute Beginner)

### 🧪 Setup & Language Basics

- ✅ **EX-1.1.01** | Hello World in Go — Create a `main.go` and print "Hello World" using `fmt.Println`.
- ✅ **EX-1.1.02** | Print your name and age using variables and formatted output.
- ✅ **EX-1.1.03** | Declare variables using both `var` and `:=`, then print them.
...
- ✅ **EX-1.2.01** | Concatenate two strings and print the result.
...
- ✅ **EX-1.3.16** | Swap two variables without a temporary variable.
...
## 🟡 LEVEL 2 — Flow Control & Data Structures
...
## 🔵 LEVEL 3 — Functions & Structs (Core Go)
...
## 🟠 LEVEL 5 — Concurrency (Go Strength)
